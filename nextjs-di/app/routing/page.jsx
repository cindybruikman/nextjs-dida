      ...
      <main className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Next.js provides a powerful routing mechanism using pages and
            dynamic routing. You create routes simply by creating files inside
            the `pages` folder. For dynamic routes, you can use brackets like `
            <code>[slug].js</code>`.
          </p>
